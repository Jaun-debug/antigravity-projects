            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {mockRegions.map(region => (
                  <div key={region.id} className="bg-white rounded-xl shadow-sm border border-stone-100 overflow-hidden flex flex-col group cursor-pointer hover:shadow-md transition">
                ...
                return (
                  <div key={day.id} className="bg-white rounded-2xl shadow-sm border border-stone-200 relative group">
                    ...
                    <div className="pl-14 p-6">
                      ...
                      <div className="mt-6 border-t border-stone-100 pt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
