...
json_path = "/Users/jaunhusselmann/Downloads/14-Day Luxury Namibia Drive & Fly Photographic Safari.json"
template_path = "/Users/jaunhusselmann/Desktop/AG Projects/dt_library/11_day_namibia_wildlife_safari.html"
output_path = "/Users/jaunhusselmann/Desktop/AG Projects/dt_library/14_day_luxury_drive_fly_photographic_safari.html"
...
html = html.replace("<title>11-Day Namibia Wildlife Safari</title>", "<title>14-Day Luxury Namibia Drive & Fly Photographic Safari</title>")
html = html.replace('data-default-title="11-Day Namibia<br>Wildlife Safari"', 'data-default-title="14-Day Luxury Drive & Fly<br>Photographic Safari"')
html = html.replace('11-Day Namibia<br>Wildlife Safari', '14-Day Luxury Drive & Fly<br>Photographic Safari')
...
# 2. Hero Backgrounds - Using a striking Sossusvlei image from the new JSON
html = html.replace('https://wetu.com/imageHandler/c1920x1080/469/etosha_national_park-istock-925720816.jpg?fmt=jpg', 'https://wetu.com/imageHandler/c1920x1080/1518/arrival-area-andbeyond-sossusvlei.jpg?fmt=jpg')

# 3. Subtitle and Intro
html = html.replace('A bespoke journey across the contrasting landscapes of Namibia.', 'A bespoke 14-day photographic journey across Namibia\'s most dramatic landscapes.')
...
intro_new = "Experience the ultimate Namibian adventure with this luxury drive and fly photographic safari. From the vibrant capital of Windhoek to the endless red dunes of Sossusvlei, the coastal charm of Swakopmund, and the remote wilderness of the Kunene Region, this journey combines the freedom of a self-drive with the exclusivity of fly-in access to untouched areas. With unparalleled photographic opportunities, luxury accommodations, and spectacular wildlife encounters at every turn, this is Namibia at its absolute finest."
...
waypoints_str = '''                                const waypoints = [
                                    ...
                                    { id: '1', name: 'Kalahari', lodge: 'Bagatelle Kalahari', nights: '2 NIGHTS', coords: [-24.25, 17.9] },
                                    { id: '2', name: 'Lüderitz', lodge: 'Lüderitz Nest Hotel', nights: '2 NIGHTS', coords: [-26.6481, 15.1594] },
                                    { id: '3', name: 'Sossusvlei', lodge: 'andBeyond Sossusvlei', nights: '2 NIGHTS', coords: [-24.72, 15.33] },
                                    { id: '4', name: 'Swakopmund', lodge: 'Strand Hotel', nights: '2 NIGHTS', coords: [-22.67, 14.52] },
                                    { id: '5', name: 'Kunene', lodge: 'Serra Cafema', nights: '2 NIGHTS', coords: [-17.22, 12.33] },
                                    { id: '6', name: 'Etosha', lodge: 'Onguma Camp Kala', nights: '2 NIGHTS', coords: [-18.73, 17.04] },
                                    { id: '7', name: 'Departure', lodge: 'Hosea Kutako', nights: 'DEPART', coords: [-22.48, 17.47] }
                                ];'''
...
html = html.replace('More Extraordinary Journeys', 'Explore More Luxury Safaris')
html = re.sub(r'<div class="swiper-wrapper">.*?</div>\s+</div>\s+<!-- Custom Controls', f'<div class="swiper-wrapper">\n                            <a href="https://wetu.com/ItineraryOutputs/Discovery/d957f35f-76c0-4276-899d-ba04411b5e9e?_gl=1*1abd97m*_gcl_au*ODU3NTYzNTQ2LjE3NzM3Mzg5MDM." target="_blank" class="swiper-slide dt-coverflow-slide">\n                                <img src="https://desert-tracks.com/wp-content/uploads/2025/10/savuti-lion-in-the-road.jpeg" alt="14-Day Luxury Namibia Drive &amp; Fly Photo Safari" loading="lazy">\n                                <div class="dt-slide-gradient"></div>\n                                <div class="dt-slide-content">\n                                    <span class="dt-slide-days">14 Days</span>\n                                    <h3 class="dt-slide-title">14-Day Luxury Namibia Drive &amp; Fly Photo Safari</h3>\n                                </div>\n                            </a>\n                            <a href="https://wetu.com/ItineraryOutputs/Discovery/b02e8a98-0fe9-4d6b-9a85-8fcc81355557?_gl=1*1abd97m*_gcl_au*ODU3NTYzNTQ2LjE3NzM3Mzg5MDM." target="_blank" class="swiper-slide dt-coverflow-slide">\n                                <img src="https://desert-tracks.com/wp-content/uploads/2025/11/29c1a07ebd3fcf987a8cbfce29564ecda4c8c2cb01656ab89e940f236d2c438275cdee4f5a503b6939a5008af8e8e5445682ea5a966bd418fb17bd_1280-1.jpg" alt="14-Day Luxury Namibia Highlights Self-Drive Safari" loading="lazy">\n                                <div class="dt-slide-gradient"></div>\n                                <div class="dt-slide-content">\n                                    <span class="dt-slide-days">14 Days</span>\n                                    <h3 class="dt-slide-title">14-Day Luxury Namibia Highlights Self-Drive Safari</h3>\n                                </div>\n                            </a>\n                            <a href="https://wetu.com/Itinerary/Landing/8d67bdc1-417a-411c-ac60-e312537c8730?_gl=1*269is8*_gcl_au*ODU3NTYzNTQ2LjE3NzM3Mzg5MDM." target="_blank" class="swiper-slide dt-coverflow-slide">\n                                <img src="https://desert-tracks.com/wp-content/uploads/2025/11/wilderness-desert-rhino-camp_3-scaled-3.jpg" alt="12-Day Namibia Self-Drive Luxury Safari Circuit" loading="lazy">\n                                <div class="dt-slide-gradient"></div>\n                                <div class="dt-slide-content">\n                                    <span class="dt-slide-days">12 Days</span>\n                                    <h3 class="dt-slide-title">12-Day Namibia Self-Drive Luxury Safari Circuit</h3>\n                                </div>\n                            </a>\n                            <a href="https://wetu.com/ItineraryOutputs/Discovery/f959961b-5ea6-43dc-b713-5a2fb0928eb1?_gl=1*269is8*_gcl_au*ODU3NTYzNTQ2LjE3NzM3Mzg5MDM." target="_blank" class="swiper-slide dt-coverflow-slide">\n                                <img src="https://desert-tracks.com/wp-content/uploads/2025/11/divava-1.jpg" alt="10-Day Namibia Honeymoon Luxury Fly-In Safari" loading="lazy">\n                                <div class="dt-slide-gradient"></div>\n                                <div class="dt-slide-content">\n                                    <span class="dt-slide-days">10 Days</span>\n                                    <h3 class="dt-slide-title">10-Day Namibia Honeymoon Luxury Fly-In Safari</h3>\n                                </div>\n                            </a>\n                            <a href="https://wetu.com/ItineraryOutputs/Discovery/487e81b5-4faf-4bdc-88f7-d28a3b229cdf?_gl=1*269is8*_gcl_au*ODU3NTYzNTQ2LjE3NzM3Mzg5MDM." target="_blank" class="swiper-slide dt-coverflow-slide">\n                                <img src="https://desert-tracks.com/wp-content/uploads/2025/11/bc95b679-56fc-4800-b602-5d040fe0cced-png-1.webp" alt="10-Day Ultra-Luxury Namibia Safari - North Focus" loading="lazy">\n                                <div class="dt-slide-gradient"></div>\n                                <div class="dt-slide-content">\n                                    <span class="dt-slide-days">10 Days</span>\n                                    <h3 class="dt-slide-title">10-Day Ultra-Luxury Namibia Safari - North Focus</h3>\n                                </div>\n                            </a>\n                            <a href="https://wetu.com/ItineraryOutputs/Discovery/e3ab6f95-cd77-4d07-943b-45d8257dda6c" target="_blank" class="swiper-slide dt-coverflow-slide">\n                                <img src="https://desert-tracks.com/wp-content/uploads/2025/11/bagatelle-lodge-kalahari-game-ranch-namibia-chalte-on-dune2-1.jpg" alt="10-Day Ultra-Luxury Namibia Safari - South Focus" loading="lazy">\n                                <div class="dt-slide-gradient"></div>\n                                <div class="dt-slide-content">\n                                    <span class="dt-slide-days">10 Days</span>\n                                    <h3 class="dt-slide-title">10-Day Ultra-Luxury Namibia Safari - South Focus</h3>\n                                </div>\n                            </a>\n                        </div>\n                    </div>\n                    <!-- Custom Controls', html, flags=re.DOTALL)


with open(output_path, 'w') as f:
    f.write(html)

print("Generated 14_day_luxury_drive_fly_photographic_safari.html successfully!")
