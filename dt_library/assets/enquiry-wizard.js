...
;(function(){"use strict";try{
  ...
  function css(){
    ...
    s.textContent=
      ...
      +"#nr-lodge-yr button{cursor:pointer;font:inherit;font-size:.72rem;letter-spacing:.5px;padding:5px 13px;border-radius:4px;-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border:1px solid rgba(135,169,150,.88);background:rgba(255,255,255,.78);color:#4f7a63;transition:background .18s,color .18s}"
      +"#nr-lodge-yr button.on{background:rgba(135,169,150,.88);color:#fff}"
      +"#nr-lodge-yr-note{margin:0 2px 16px;padding:12px 16px;border-radius:10px;background:rgba(135,169,150,.12);border:1px solid rgba(135,169,150,.45);color:#3f6451;font-size:.84rem;line-height:1.45}";
