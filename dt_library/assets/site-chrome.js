...
;(function(){"use strict";try{
  ...
  function injectCss(){
    ...
    s.textContent=
      ...
      +"#nr-yrtoggle button{cursor:pointer;font:inherit;font-size:.72rem;letter-spacing:.5px;padding:5px 13px;border-radius:4px;-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border:1px solid rgba(135,169,150,.88);background:rgba(200,90,23,.08);color:#c85a17;transition:background .18s,color .18s}"
