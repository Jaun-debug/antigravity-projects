...
;(function(){"use strict";
  ...
  var css=".nr-step{display:inline-flex;align-items:stretch;border:1px solid #dcdcdc;border-radius:6px;overflow:hidden;background:#fff;vertical-align:middle;height:42px;flex:0 0 auto}"
   +".nr-step button{flex:0 0 38px;width:38px;border:0;background:#fff;color:#444;font:inherit;font-size:18px;line-height:1;cursor:pointer;padding:0;margin:0;transition:background .15s;box-shadow:none}"
   +".nr-step button:hover{background:rgba(135,169,150,.14)}.nr-step button:active{background:rgba(135,169,150,.28)}"
   +".nr-step input{width:52px!important;min-width:0!important;max-width:none!important;height:auto!important;text-align:center!important;border:0!important;border-left:1px solid #cfcfcf!important;border-right:1px solid #cfcfcf!important;border-radius:0!important;background:#fff!important;box-shadow:none!important;margin:0!important;padding:0 4px!important;font-size:1rem!important;color:#444!important;-moz-appearance:textfield;outline:none}"
  ...
  function wrap(el){
    var w=document.createElement('span');w.className='nr-step';
