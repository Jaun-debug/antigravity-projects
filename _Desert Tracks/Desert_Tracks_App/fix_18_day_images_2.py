...
real_images = {
    ...
    "day-05": "https://wetu.com/imageHandler/c1920x1080/68363/1.jpg?fmt=jpg", # Alte Villa (Day 5)
    ...
    "day-07": "https://wetu.com/imageHandler/c1920x1080/10515/ondili_desert_homestead_venture_media--23.jpg?fmt=jpg", # Desert Homestead (Day 6&7, day-06)
    "day-08": "https://wetu.com/imageHandler/c1920x1080/149035/exterior_24.jpg?fmt=jpg", # Swakop Guesthouse
    "day-09": "https://wetu.com/imageHandler/c1920x1080/149035/exterior_24.jpg?fmt=jpg", # Swakop Guesthouse
    ...
    "day-13": "https://wetu.com/imageHandler/c1920x1080/34701/omarunga-scenery21.jpg?fmt=jpg", # Omarunga
    ...
    "day-16": "https://wetu.com/imageHandler/c1920x1080/10560/etosha_game_drive1.jpg?fmt=jpg", # Etosha Safari
        ...
        if day_id in real_images:
            ...
            if track_start != -1:
                ...
                if footer_start != -1:
                    ...
                    # replace everything between <div class="dt-film-track"> and the end of the track wraps
                    
                    # We know that the block has:
                    # <div class="dt-film-track">
                    #   ... (cards) ...
                    # </div>
                    # </div>  (closes track-wrap)
                    # <div class="dt-film-footer">
                    inner_html = block[track_start+len('<div class="dt-film-track">'):footer_start]
                    
                    # just inject exactly new_cards inside <div class="dt-film-track">
                    # meaning replace everything between `<div class="dt-film-track">` and `</div>\n                </div>\n\n                <div class="dt-film-footer">`
                    
                    # find `<div class="dt-film-track">`
